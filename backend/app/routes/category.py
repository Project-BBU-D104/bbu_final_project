...
from app.crud.category import  create_category, get_all_category, get_category, update_category, delete_category
...
def update_category_route(category_id: int, category: CategoryCreate, session: Session = Depends(get_session)):
