...
__all__ = ["users_router",category_router,product_router,supplier_router,customer_router,role_router,audit_logs_router,warehouse_router, stock_adjustment_router, product_transfer_router]